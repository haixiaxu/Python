...
def draw_str(count, image, font_size):
    ...
    font = ImageFont.truetype(font=None, size=font_size, index=0, encoding='')  # ImageFont.truetype(size=font_size)
    temp = []
    for i in random(count):
